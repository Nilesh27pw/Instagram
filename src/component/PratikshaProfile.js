    ...
    <div>
        ...
        <div className="ctQZ">   
            <div className="_47KiJ">
                ...
                <p style={{marginTop : 30,  marginLeft:35,fontSize : 25}}>557</p>
        ...
        <div className="ctQZ">   
            ...
            <div className="ctQZ">   
            <div className="_47KiJ">
                <img src={Pratiksha1} style={{marginTop :10, marginRight:20,fontWeight : 100, blockSize : 100}}></img>
                <img src={Pratiksha2} style={{marginTop : 10, marginRight:50,fontWeight : 100, blockSize : 100}}></img>
